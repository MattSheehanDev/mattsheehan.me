...
module Jekyll
  ...
  class TileTemplater < Generator
    ...
    def generate(site)
      ...
      site.static_files.push(TileConfig.new(site, site.source, "/ietemplates/", "ieconfig.xml"))
      ...
      posts.reverse[0..count].each_with_index do |post, index|
        site.static_files.push(TilePoll.new(site, site.source, "/ietemplates/", "poll#{index+1}.xml", post))
      end
    end
